    ...
    where TMessage : class
{
    ...
    public MessageHandlerMappingBuilder(KafkaConsumerBuilder<TMessage> kafkaConsumerBuilder)
    {
    ...
    public  MessageHandlerMappingBuilder<TMessage> When(Func<MessageModel<TMessage>, bool> predicate)
    {
